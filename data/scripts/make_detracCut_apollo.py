...
pipeline = Pipeline()
target2id = {'bicycle': 1, 'motorcycle': 3, 'dog': 16, 'cat': 15, 'car': 2}
...
if __name__ == '__main__':
    ...
    ratio = {15: [30, 50], 16: [30, 50],
             1: [30, 100], 3: [30, 100], 2: [30, 100]}
    mask_dir = '/mnt/ActionRecog/dataset/apollo_class'
    data_path = f'/mnt/ActionRecog/dataset/DETRAC_coco/{task}2021.txt'
    save_dir = f'/data/dataset/yolo_dataset/detracCut_apollo'
    paste_cls = ['bicycle', 'motorcycle', 'car']
    ...
    for cls in paste_cls:
        mask_list = glob.glob(os.path.join(mask_dir, cls, '*.png'))
