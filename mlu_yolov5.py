...
yolov5
"""
# from api_for_mlu import yolov5_net
from api_for_mlu import load_yolov5x6_model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--h',default=640, type=int)
    # Check
    ...
    model.model[-1].export_mode = 10 #special for mlu
